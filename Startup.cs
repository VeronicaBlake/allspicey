    ...
    public class Startup
    {
     ...
     }).AddJwtBearer(options =>
     {
         ...
         options.Audience = Configuration["Auth0:Audience"];
            ...
            services.AddTransient<RecipesServices>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "allspicey", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "allspicey v1"));
            }

            app.UseHttpsRedirection();

            app.UseRouting();
            // TODO[epic=auth] Break SOME LEGS!!! 
